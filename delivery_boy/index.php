...
$sql="select order_master.*,order_status.order_status as order_status_str 
        ...
        where order_master.order_status=order_status.id and order_master.delivery_boy_id='".$_SESSION['DELIVERY_BOY_ID']."' and order_master.order_status!=4 order by order_master.id desc";
