...
$fitemarray=implode(",",$fitem);
    $query=mysqli_query($con, "insert into tblfood(DonorID,foodId,StateName, CityName, FoodItems, Description,Quantity, PickupDate,PickupAddress,ContactPerson,CPMobNumber,Image) 
        value('$donorid','$fid','$statename','$cityname','$fitemarray','$description','$Quantity','$pdate','$padd','$contactperson','$cpmobnum','$foodpic')");
...
<td><button type="button" name="add" id="add" class="btn btn-success">Add More</button></td>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" type="text" id="Quantity" name="Quantity"  maxlength="4" required="true" value="" onBlur="numberValidation(this)"  />
